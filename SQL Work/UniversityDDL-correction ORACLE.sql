REM   Script: UniversityDDL-MSSQL
REM   Load Tables and Data
...
VALUES ('543210987','VICTORIA','EMMANUEL','BOTHELL','WA','MS','PROF',120000.0,NULL,date '1998-04-15','98011-2242');

INSERT INTO Faculty 
(FacNo, FacFirstName, FacLastName, FacCity, FacState,FacDept, FacRank, FacSalary, FacSupervisor, FacHireDate, FacZipCode)
VALUES ('654321098','LEONARD','FIBON','SEATTLE','WA','MS','ASSC',70000.00,'543210987',date '1996-05-01','98121-0094');

INSERT INTO Faculty 
(FacNo, FacFirstName, FacLastName, FacCity, FacState,FacDept, FacRank, FacSalary, FacSupervisor, FacHireDate, FacZipCode)
VALUES ('098765432','LEONARD','VINCE','SEATTLE','WA','MS','ASST',35000.00,'654321098',date '1997-04-10','98111-9921');

INSERT INTO Faculty 
(FacNo, FacFirstName, FacLastName, FacCity, FacState,FacDept, FacRank, FacSalary, FacSupervisor, FacHireDate, FacZipCode)
VALUES ('765432109','NICKI','MACON','BELLEVUE','WA','FIN','PROF',65000.00,NULL,date '1999-04-11','98015-9945');

INSERT INTO Faculty 
(FacNo, FacFirstName, FacLastName, FacCity, FacState,FacDept, FacRank, FacSalary, FacSupervisor, FacHireDate, FacZipCode)
VALUES ('876543210','CRISTOPHER','COLAN','SEATTLE','WA','MS','ASST',40000.00,'654321098',date '2001-03-01','98114-1332');

INSERT INTO Faculty 
(FacNo, FacFirstName, FacLastName, FacCity, FacState,FacDept, FacRank, FacSalary, FacSupervisor, FacHireDate, FacZipCode)
VALUES ('987654321','JULIA','MILLS','SEATTLE','WA','FIN','ASSC',75000.00,'765432109',date '2002-03-15','98114-9954');
